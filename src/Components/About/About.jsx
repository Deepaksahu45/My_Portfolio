    ...
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          {/* Greeting */}
          <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold text-black dark:text-white mb-2 leading-tight">
            Hi, I am
          </h1>

          <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-black dark:text-white mb-4 leading-tight">
            Deepak Sahu
          </h2>
          ...
          {/* Resume button */}
          <a
            href="https://drive.google.com/file/d/12qJDSWnqXGl_zZpl-KS-1CZAdWUN51i5/view?usp=drive_link"
            target="_blank"
