  ...
  return (
    <section
      ...
      className="py-24 pb-24 px-[12vw] md:px-[7vw] lg:px-[20vw] font-sans 
                 bg-skills-gradient dark:bg-[#050414] clip-path-custom"
    >
      {/* Section title */}
      <div className="text-center mb-8">
        ...
        <div className="flex flex-wrap gap-1 lg:gap-5 py-10 justify-between">
          {SkillsInfo.map((category) => (
            <div
              key={category.title}
              className="bg-white/70 dark:bg-white/5 backdrop-blur-md px-6 sm:px-10 py-8 sm:py-6 
                         mb-10 w-full sm:w-[48%] rounded-2xl border border-gray-200 dark:border-white/10 
                         shadow-[0_0_20px_1px_rgba(130,69,236,0.31)]"
            >
                  ...
                  {category.skills.map((skill) => (
                    <div
                      ...
                      className="flex items-center justify-center space-x-2 
                                 ...
                                 rounded-3xl py-2 px-2 text-center"
                    >
                      <img
                        src={skill.logo}
                        alt={`${skill.name} logo`}
